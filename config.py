...
class BotStates:
    ...
    MODE3_UPLOADING = "mode3_uploading"
    MODE3_CAPTIONING = "mode3_captioning"
    EDIT_POSTS_MENU = "edit_posts_menu"
    EDIT_POST_CAPTION = "edit_post_caption"
    EDIT_POST_MEDIA = "edit_post_media"
    EDIT_POST_SCHEDULE = "edit_post_schedule"
